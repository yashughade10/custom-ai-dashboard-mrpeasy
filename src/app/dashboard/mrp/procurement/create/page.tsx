...
export default function CreatePurchaseOrderPage() {
  ...
  const MOCK_PRODUCT_GROUPS = [
    { id: "AG00001", name: "AG00001 Paint, Coatings & Plating" },
    { id: "AG000011", name: "AG000011 WORKSHOP GENERAL SUPPLIES" },
    { id: "AG00002", name: "AG00002 Subassemblies" },
    { id: "AG00003", name: "AG00003 Final assemblies" },
    { id: "AG00004", name: "AG00004 Blue Water Engineering" },
    { id: "AG00004.1", name: "AG00004.1 Vaclift" }
  ];

  const MOCK_ITEMS = [
    { id: "28266", name: "28266 \"ADORACION\" 1205 MM LONG", price: 10.00 },
    { id: "A0001404", name: "A0001404 \"ARRESTOR PUMP OUT FUELING POINT HOSE TAP\" SIGN AS DRAWING PROVIDED", price: 20.00 },
    { id: "A0000935", name: "A0000935 \"Arrivederci\" E-Polished", price: 30.00 },
    { id: "A0000807", name: "A0000807 \"Audacious\" E-Polished", price: 40.00 },
    { id: "28222", name: "28222 \"BIKINI\" 296 MM LONG", price: 50.00 },
    { id: "A0000985", name: "A0000985 \"Black Magic\" E-Polished", price: 60.00 },
    { id: "A0000697", name: "A0000697 AJM-SIGN", price: 35.00 },
    { id: "A0000622", name: "A0000622 CUT OFF 500M", price: 150.00 }
  ];
  ...
  const [lineItems, setLineItems] = useState([
    ...
    { id: '2', productGroup: '', item: '', vendorPartNo: '', orderedQuantity: '', price: '', subtotal: '', expectedQuantity: '', expectedDate: '', arrivalDate: '', freeText: '' },
    { id: '3', productGroup: '', item: '', vendorPartNo: '', orderedQuantity: '', price: '', subtotal: '', expectedQuantity: '', expectedDate: '', arrivalDate: '', freeText: '' }
  ]);
  ...
  const handleLineItemChange = (id: string, field: string, value: string) => {
    setLineItems(prev => prev.map(item => {
      if (item.id === id) {
        ...
        if (field === 'item') {
          const matchedItem = MOCK_ITEMS.find(m => m.id === value);
          if (matchedItem) {
            updated.price = matchedItem.price.toFixed(2);
            const qty = parseFloat(updated.orderedQuantity) || 0;
            updated.subtotal = (qty * matchedItem.price).toFixed(2);
          }
        }
      ...
      <div className="grid grid-cols-2 gap-x-12 gap-y-4">
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Vendor *</label>
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Status</label>
            <div className="flex-1">
              <select
                name="status"
                value={formData.status}
                onChange={handleChange}
                className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-1.5 text-sm outline-none focus:border-blue-400"
              >
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Currency</label>
            <div className="flex-1">
              <SearchableSelect
                options={currencyOptions}
                value={formData.currency}
                onChange={(val) => setFormData({ ...formData, currency: val })}
                onAddOption={(val) => setFormData({ ...formData, currency: val })}
          ...
          <div className="flex items-start">
            <label className="w-32 text-sm text-gray-600 text-right pr-4 pt-2">Free text</label>
            <div className="flex-1">
              <textarea 
                name="po_free_text"
                value={formData.po_free_text}
                onChange={handleChange}
                className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-2 text-sm outline-none focus:border-blue-400 min-h-[60px] resize-y"
              />
            </div>
          </div>

          <div className="flex items-start">
            <label className="w-32 text-sm text-gray-600 text-right pr-4 pt-1.5">Files</label>
            <div className="flex-1 flex flex-col gap-2">
              <div className="flex gap-2">
                <div onClick={() => openOAuthPopup('google')} className="p-1.5 bg-[#e8eff9] text-blue-600 rounded cursor-pointer hover:bg-blue-100"><Cloud className="w-4 h-4" /></div>
                <div onClick={() => openOAuthPopup('dropbox')} className="p-1.5 bg-[#e8eff9] text-blue-600 rounded cursor-pointer hover:bg-blue-100"><UploadCloud className="w-4 h-4" /></div>
                <div onClick={() => openOAuthPopup('microsoft')} className="p-1.5 bg-[#e8eff9] text-blue-600 rounded cursor-pointer hover:bg-blue-100"><FileText className="w-4 h-4" /></div>
                <div onClick={() => setShowLinkModal(true)} className="p-1.5 bg-[#e8eff9] text-blue-600 rounded cursor-pointer hover:bg-blue-100"><LinkIcon className="w-4 h-4" /></div>
              </div>
              
              {attachedFiles.length > 0 && (
                <div className="mt-2 flex flex-col gap-1">
                  <div className="text-sm font-medium text-gray-700 bg-gray-100 px-2 py-1 rounded w-fit mb-1">File</div>
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">B.W.E. Job ID *</label>
            <div className="flex-1">
              <input 
                type="text" 
                name="bwe_job_id"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">PO Emailed</label>
            <div className="flex-1">
              <select 
                name="po_emailed"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Attention *</label>
            <div className="flex-1">
              <select
                name="attention"
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Expected date *</label>
            <div className="flex-1">
              <input 
                type="date" 
                name="expected_date"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Order ID</label>
            <div className="flex-1">
              <input 
                type="text" 
                name="order_id"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Order date</label>
            <div className="flex-1">
              <input 
                type="date" 
                name="order_date"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Invoice ID</label>
            <div className="flex-1">
              <input 
                type="text" 
                name="invoice_id"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Invoice date</label>
            <div className="flex-1">
              <input 
                type="date" 
                name="invoice_date"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Due date</label>
            <div className="flex-1">
              <input 
                type="date" 
                name="due_date"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Shipped on</label>
            <div className="flex-1">
              <input 
                type="date" 
                name="shipped_on"
          ...
          <div className="flex items-center">
            <label className="w-32 text-sm text-gray-600 text-right pr-4">Arrival date</label>
            <div className="flex-1">
              <input 
                type="date" 
                name="arrival_date"
        ...
        <table className="w-full min-w-[1200px] text-sm text-left">
          <thead className="bg-[#eef1f6] text-gray-600 font-medium">
            <tr>
              ...
              <th className="px-2 py-2 font-medium">Product group</th>
              <th className="px-2 py-2 font-medium">Item</th>
              <th className="px-2 py-2 font-medium">Vendor part no.</th>
          ...
          <tbody>
              ...
              >
                ...
                <td className="px-2 py-3 align-top">
                  <select 
                    ...
                    onChange={(e) => handleLineItemChange(item.id, 'productGroup', e.target.value)}
                    className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-1.5 outline-none text-sm text-gray-700"
                  >
                    <option value="">Select...</option>
                    <option value="ADD_NEW" className="font-medium text-blue-600">Add a new group</option>
                    {MOCK_PRODUCT_GROUPS.map(g => (
                ...
                <td className="px-2 py-3 align-top space-y-1">
                  ...
                  >
                    <option value="">Select...</option>
                    <option value="ADD_NEW" className="font-medium text-blue-600">Add a new product</option>
                    {MOCK_ITEMS.map(i => (
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-1.5 outline-none resize-none h-8 text-sm" 
                  />
                </td>
                <td className="px-2 py-3 align-top">
                  <select 
                    value={item.vendorPartNo}
                    onChange={(e) => handleLineItemChange(item.id, 'vendorPartNo', e.target.value)}
                    className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-1.5 outline-none text-sm text-gray-700"
                  >
                    <option value="">Select...</option>
                  </select>
                ...
                <td className="px-2 py-3 align-top">
                  <input 
                    ...
                    className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-1.5 outline-none text-sm" 
                  />
                </td>
                <td className="px-2 py-3 align-top">
                ...
                <td className="px-2 py-3 align-top">
                  <div className="flex items-center gap-2">
                    <input 
                      ...
                      value={item.subtotal} 
                      readOnly 
                      className="w-16 bg-[#f4f7fb] border border-gray-200 rounded p-1.5 outline-none text-center text-sm" 
                    />
                    <span className="text-gray-600 font-medium text-sm">$</span>
                  </div>
                </td>
                ...
                <td className="px-2 py-3 align-top">
                  <div className="relative">
                    <input 
                      ...
                      className={`w-full bg-[#f4f7fb] border border-gray-200 rounded p-1.5 outline-none text-sm ${!item.expectedDate ? 'text-transparent' : 'text-gray-800'}`} 
                    />
                    {!item.expectedDate && (
            ...
            <tr className="border-b border-gray-100">
              ...
              <td className="px-2 py-3">
                <div className="flex items-center gap-2">
                  <input type="text" className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-1.5 outline-none text-sm" />
                  <span className="text-gray-600 font-medium text-sm">%</span>
                </div>
              </td>
              <td className="px-2 py-3">
                <div className="flex items-center gap-2">
                  <input type="text" className="w-full bg-[#e8eff9] border border-blue-200 rounded p-1.5 outline-none text-sm" />
                  <span className="text-gray-600 font-medium text-sm">$</span>
                </div>
              </td>
              <td colSpan={4}></td>
            ...
            <tr className="border-b border-gray-100">
              <td></td>
              <td colSpan={5} className="px-2 py-3 font-medium text-gray-800 text-sm">Total:</td>
              <td className="px-2 py-3 font-medium text-gray-800 text-sm whitespace-nowrap">$ 1.00</td>
              <td colSpan={4}></td>
            </tr>
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#f4f7fb] border border-gray-200 rounded p-2 text-sm outline-none focus:border-blue-400"
                />
              </div>
            </div>
