...
import { Plus, Search, RefreshCw, Settings2, Download } from "lucide-react";
      ...
      <div className="bg-white rounded-md shadow-sm flex flex-col h-full overflow-hidden">
        ...
        <div className="px-4 py-3 flex flex-wrap items-center justify-between gap-3 bg-white border-b border-gray-100">
          ...
          <div className="flex items-center gap-2 self-start">
            <Button variant="outline" size="sm" className="h-7 w-7 p-0 bg-gray-50/50 text-gray-600 rounded-sm">
              <Search className="h-3.5 w-3.5" />
            </Button>
            <Button variant="outline" size="sm" className="h-7 px-3 gap-1.5 bg-gray-50/50 text-gray-600 rounded-sm">
              <Download className="h-3.5 w-3.5" /> PNG
            </Button>
            <Button variant="outline" size="sm" className="h-7 px-3 bg-gray-50/50 text-gray-600 font-medium rounded-sm">
              Gantt chart
            </Button>
            <Button variant="outline" size="sm" className="h-7 w-7 p-0 bg-gray-50/50 text-gray-600 rounded-sm">
