  ...
  return (
    <div className="flex flex-col h-full bg-[#f4f7fb] min-h-[calc(100vh-4rem)] p-4 sm:p-6 lg:p-8">
      <div className="max-w-3xl w-full">
        {/* Header */}
        <h1 className="text-2xl font-bold text-slate-900 mb-6">Contact person PAUL TURNER details</h1>
        ...
        <div className="bg-white p-6 rounded shadow-sm border border-gray-200">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-[140px_1fr] items-center gap-4">
              ...
              <Input defaultValue="PAUL TURNER" className="h-9 bg-blue-50/30 border-blue-300 focus-visible:ring-blue-500 rounded-sm" />
            </div>
